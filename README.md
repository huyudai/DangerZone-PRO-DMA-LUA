# 关于DangerZone-PRO-DMA-LUA
## 声明和警告
所有功能均只对MEMORY进行READ(LDR)操作，**没有任何例外**。<br>
所有加密的代码中均不包含恶意代码，**没有任何例外**。<br>
如果你介意加密，请立即停止使用LUA。<br>
严禁中国大陆地区用户使用第三方软件和使用本lua，请遵守当地法律法规，远离计算机犯罪。<br>
使用本lua，你最好需要75以上的IQ<br>
本lua是免费的，以免部分弱智拿本lua作其他用途，lua是加密的。<br>
**lua是没有恶意的，PRO不支持从外部下载文件。**<br>
部分lua需要静态文件，请你按照指示放入对应目录。<br>
当lua出现问题时，建议你使用LUA编辑器查看输出<br>
通常来说，我们会将lua测试15天再上传至此，因此，你不需要担心LUA有显然的问题。<br>
## 特别鸣谢
**PRO开发者**<br>
